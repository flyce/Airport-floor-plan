        ...
        value: function renderPageNums() {
            ...
            return this.range().map(function (pageNum, index) {
                return pageNum === '.' ? _react2.default.createElement(
                    ...
                    '\u2026'
                ) : _react2.default.createElement(_FlatButton2.default, { key: pageNum, label: pageNum, 'data-page': pageNum, onClick: _this2.gotoPage, primary: pageNum !== _this2.props.page, style: styles.button });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return width === 1 ? _react2.default.createElement(
                ...
                nbPages > 1 && _react2.default.createElement(
                    _Toolbar.ToolbarGroup,
                    null,
                    page > 1 && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'prev', label: translate('aor.navigation.prev'), icon: _react2.default.createElement(_chevronLeft2.default, null), onClick: this.prevPage, style: styles.button }),
                    this.renderPageNums(),
                    page !== nbPages && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'next', label: translate('aor.navigation.next'), icon: _react2.default.createElement(_chevronRight2.default, null), labelPosition: 'before', onClick: this.nextPage, style: styles.button })
                )
            );
        }
    }]);
