...
var minLength = exports.minLength = function minLength(min) {
    return function (value, _, props) {
        return value && value.length < min ? props.translate('aor.validation.minLength', { min: min }) : undefined;
    };
};

var maxLength = exports.maxLength = function maxLength(max) {
    return function (value, _, props) {
        return value && value.length > max ? props.translate('aor.validation.maxLength', { max: max }) : undefined;
    };
};

var minValue = exports.minValue = function minValue(min) {
    return function (value, _, props) {
        return value && value < min ? props.translate('aor.validation.minValue', { min: min }) : undefined;
    };
};

var maxValue = exports.maxValue = function maxValue(max) {
    return function (value, _, props) {
        return value && value > max ? props.translate('aor.validation.maxValue', { max: max }) : undefined;
    };
};
